                    ...
                    <div
                      ...
                      style={{
                        background: msg.role === "user"
                          ? "linear-gradient(145deg, rgba(30, 65, 140, 0.65), rgba(20, 50, 115, 0.55))"
                          : "linear-gradient(145deg, rgba(35, 75, 150, 0.55), rgba(25, 55, 120, 0.45))",
                        ...
                        borderTop: msg.role === "user"
                          ...
                          : "1px solid rgba(186, 230, 253, 0.30)",
              ...
              {chatLoading && (
                <div className="flex justify-start mb-3">
                  <div
                    ...
                    style={{
                      background: "linear-gradient(145deg, rgba(35, 75, 150, 0.55), rgba(25, 55, 120, 0.45))",
                  ...
                  >
                    <span className="inline-flex items-center">
                      <span className="animate-pulse" style={{ color: "rgba(186, 230, 253, 0.8)" }}>...</span>
